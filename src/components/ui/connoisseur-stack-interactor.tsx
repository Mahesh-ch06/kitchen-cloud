...
export const ConnoisseurStackInteractor = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "flex flex-col md:flex-row items-center justify-between min-h-[80vh] w-full p-8 md:p-24 overflow-hidden transition-colors duration-500",
    ...
    >
                ...
                <div className="flex items-start gap-6">
                  <span
                    className={cn(
                      ...
                      activeIndex === index ? "text-orange-500 scale-110" : "text-zinc-400 dark:text-zinc-600"
                    )}
                  >
                    {item.num}
                  </span>
      ...
      <div className="relative w-full md:w-1/2 flex justify-center items-center mt-16 md:mt-0">
        ...
        <svg viewBox="0 0 500 500" className="w-full max-w-[500px] h-auto z-10 drop-shadow-xl dark:drop-shadow-[0_0_60px_rgba(0,0,0,0.8)]">
          <defs>
